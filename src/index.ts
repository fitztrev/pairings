...
async function playerList(): Promise<Player[]> {
...
async function pairings(): Promise<Pairing[]> {
...
function formatPairings(players: Player[], pairings: Pairing[]): PairingResult[] {
...
playerList().then((players) => {
    console.log(players);

    pairings().then((pairings) => {
